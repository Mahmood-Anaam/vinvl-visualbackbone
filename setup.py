...
def get_extensions():
    ...
    this_dir = os.path.join(this_dir,"scene_graph_benchmark")
...
setup(
    ...
    packages=find_packages(where="scene_graph_benchmark",exclude=("configs", "tests",)),
    package_dir={"": "scene_graph_benchmark"},
    license="MIT",
    install_requires=[
        "ipython",
        "h5py",
